...
describe("Shape", () => {
    ...
    describe("Triangle", () => {
        it("Calls the render function and outputs a triangle", () => {
            ...
            const expectedVal = `<svg width="300" height="200">
<polygon points="150, 18 244, 182 56, 182" fill="blue" />
<text x="150" y="130" font-size="40" text-anchor="middle" fill="white">CAR</text>
</svg>`;
        ...
        describe("Circle", () => {
            it("Calls the render function and outputs a circle", () => {
                ...
                const expectedVal = `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
...
<text x="150" y="125" font-size="60" text-anchor="middle" fill="red">WOW</text>
        ...
        describe("Square", () => {
            it("Calls the render function and outputs a square", () => {
                ...
                const expectedVal = `<svg width="300" height="200">
<rect width="300" height="200" fill="grey" />
<text x="150" y="125" font-size="60" text-anchor="middle" fill="blue">BAT</text>
</svg>`
                expect(shape.render()).toEqual(expectedVal);
            });
